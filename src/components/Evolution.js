...
const Evolution = () => {
    ...
    const evolution = UsefetchData(speciesPokemon.evolution_chain.url,setIsLoaded)
                ...
                <div className="col-12 d-flex justify-content-center align-items-center flex-column flex-xl-row">            
                    {
                        <div className="col-12 col-xl-3 py-3">
                            ...
                            {
                                <EvolutionImage url={`https://pokeapi.co/api/v2/pokemon/${evolution.chain.species.url.split('/pokemon-species/')[1].slice(0, -1)}`}></EvolutionImage>
                            }
                        </div>
                    }
                    {evolution.chain.evolves_to.length > 0&&<Fragment>
                    {
                    ...
                    {                        
                        ...
                        {
                            <EvolutionImage url={`https://pokeapi.co/api/v2/pokemon/${evolution.chain.evolves_to[0].species.url.split('/pokemon-species/')[1].slice(0, -1)}`}></EvolutionImage>
                        }
                    </div>
                    }
                    </Fragment>}
                    {evolution.chain.evolves_to.length&&evolution.chain.evolves_to[0].evolves_to.length > 0&&<Fragment>
                    {                        
                        <div className="col-12 col-xl-1 d-flex justify-content-center align-items-center py-5">
                            {
                                <span>
                    ...
                    {                        
                        <div className="col-12 col-xl-3 py-3">
                            ...
                            {
                                <EvolutionImage url={`https://pokeapi.co/api/v2/pokemon/${evolution.chain.evolves_to[0].evolves_to[0].species.url.split('/pokemon-species/')[1].slice(0, -1)}`}></EvolutionImage>
                            }
                        </div>
                    }
                    </Fragment>}
